...
@section("content")
  ...
  <link href="{{ asset("stylepeminjamanruangan.css") }}" rel="stylesheet">
  ...
  <section class="container">
    ...
    <a href="ajukansurat"><button class="trans" type="button">Ajukan Surat</button></a>
                ...
                <td>
                  @if ($proposal["status"] == "sekjen" && $proposal["status_persetujuan"] == "approved")
                    ...
                    @if ($proposal["file_final_sekjen"])
                      <a class="blue" href="{{ Storage::url($proposal["file_final_sekjen"]) }}" target="_blank">
                        <img class="star-img" src="/img/filetransparan.svg" alt="" />
                      </a>
                    @else
                      belum diupload
                  ...
                  @if ($proposal["status"] == "sekjen" && $proposal["status_persetujuan"] == "approved")
                    ...
                    @else
                      <form class="finalis" action="{{ route("ormawa.upload.file.final", $proposal["id"]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input class="final" name="file_final" type="file" accept=".doc, .docx, application/pdf" required>
